...
linkRouter.delete("/:id", authControllers.verifyToken, linkControllers.deleteOneLink);
linkRouter.post("/", authControllers.verifyToken, linkControllers.createOneLink, linkControllers.getOneLinkById);
